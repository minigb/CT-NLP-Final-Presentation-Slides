...
\bottomrule
\end{tabular}
\caption{Stream-native comparison.  Sequence length 557 tokens, 0\% truncation.  All
...
\caption{Complete four-condition comparison.  All conditions trained identically;
  only the symbolic stream variant differs.  This is our primary empirical result.}
\label{tab:hardening}
\end{table}
...
\begin{tabular}{lccc}
\toprule
Comparison & Training steps & Setup & $\Delta$ aligned vs.\ shuffled \\
\midrule
Proxy task                  & 5,000 & Frozen codec + proxy head & $-0.034$ \\
Stream-native warmup        & 3,000 & Full stream integration   & $-0.018$ \\
Four-condition hardening    & 800   & Matched, identical setup  & $-0.014$ \\
\bottomrule
\end{tabular}
