...
\begin{frame}{Three Research Questions Organize This Work}
  ...
  \begin{tabular}{p{3.0cm}p{9.2cm}}
    ...
    \parbox[t]{3.0cm}{\textbf{RQ1}\\Music-aware\\understanding} &
      ...
      Metric evidence: aligned CE $<$ shuffled/dummy controls.} \\
