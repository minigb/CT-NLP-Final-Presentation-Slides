...
\begin{frame}{RQ1: Does \splan{} reduce acoustic-token uncertainty?}
  ...
  \begin{tcolorbox}[good]
    \textbf{RQ1 evidence:} aligned \splan{} is best under corrupted controls.
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{RQ1: Does \splan{} reduce acoustic-token uncertainty?}
  ...
  \smallskip
  \begin{tcolorbox}[good]
    \textbf{RQ1 replicates} in stream-native integration.
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{RQ1: Does \splan{} reduce acoustic-token uncertainty?}
  ...
  \smallskip
  \begin{tcolorbox}[good]
    \textbf{RQ1 answered positively:} aligned \splan{} gives the strongest result.
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{RQ2: Is the benefit alignment-specific?}
  ...
  \begin{tcolorbox}[good,top=2pt,bottom=2pt,fontupper=\footnotesize]
    \textbf{RQ2 answered positively:} small but consistent alignment-specific gain.
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{RQ3: Does \splan{} encode music-structural content?}
  ...
  \smallskip
  \begin{tcolorbox}[key]
    \textbf{RQ3: qualified positive} — strongest support for key and pitch-class.
  \end{tcolorbox}
\end{frame}
